...
// let path = "resources/meta-gs/weapon"
// let { abbr, alias } = await Data.importModule(`${path}/alias.js`, "miao")
// let { weaponType, weaponSet } = await Data.importModule(`${path}/extra.js`, "miao")
// let { descFix } = await Data.importModule(`${path}/desc.js`, "miao")
