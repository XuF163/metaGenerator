...
// let path = "resources/meta-gs/material"
// let { abbr } = await Data.importModule(`${path}/abbr.js`, "miao")
// let dailyData = await Data.importDefault(`${path}/daily.js`, "miao")
...
// 主要地区（与 daily.js 的数组下标对齐；新增地区可由生成器更新 daily.js）。
