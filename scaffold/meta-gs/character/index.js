...
// let path = "resources/meta-gs/character"
// let { alias } = await Data.importModule(`${path}/alias.js`, "miao")
// let { extraChars, wifeCfg } = await Data.importModule(`${path}/extra.js`, "miao")
